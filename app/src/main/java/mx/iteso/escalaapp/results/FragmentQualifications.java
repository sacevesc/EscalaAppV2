...
public class FragmentQualifications extends Fragment {
    ...
    public void onStart() {
        ...
        Query compsDatabse = FirebaseDatabase.getInstance().getReference().child("Results").child("Qualifications").child("-LBnKtYLonGvlizvO9NY").child(actualCategory).orderByChild("ranking");
        ...
        compsDatabse.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    final Query bouldersDB = FirebaseDatabase.getInstance().getReference().child("Results").child("Qualifications").child("-LBnKtYLonGvlizvO9NY").child("Principiantes").child(resultKey).child("boulders").orderByChild("number");
