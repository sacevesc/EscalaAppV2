...
public class FragmentSemifinal extends Fragment {
    ...
    public void setActualCategory(String categoryReceived) {
        ...
        Log.w("Category", "semifinal-" + categoryReceived, null);
    ...
    public void onStart() {
        super.onStart();
        Query compsDatabse = FirebaseDatabase.getInstance().getReference().child("Results").child("Semifinals").child("-LBnKtYLonGvlizvO9NY").child(actualCategory).orderByChild("ranking");
        ...
        compsDatabse.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    final Query bouldersDB = FirebaseDatabase.getInstance().getReference().child("Results").child("Semifinals").child("-LBnKtYLonGvlizvO9NY").child(actualCategory).child(resultKey).child("boulders").orderByChild("number");
